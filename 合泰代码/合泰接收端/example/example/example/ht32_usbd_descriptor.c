...
__ALIGN4 static uc8 guUSB_ConfnDesc[] =
{
  ...
  1,                          // bNumEndpoints       1 Number of endpoints used by this interface
  CLASS_INF_CLASS,            // bInterfaceClass     1 Class code (assigned by USB-IF)
  0x01,         // bInterfaceSubClass  1 Subclass code (assigned by USB-IF)
  0x02,             // bInterfaceProtocol  1 Protocol code (assigned by USB)
  ...
  0x03,                       // bmAttribute         1 Endpoint Attribute
                              ...
                              //                                  11 = Interrupt
                              //                        All other reserved
  0x10,          // wMaxPacketSize      2 Maximum packet size
	0x00,
  0x04,                       // bInterval           1 Interval for polling endpoint			59	25
...
__ALIGN4 static uc8 guUSB_StringDescProduct[] =
{
  ...
  DESC_TYPE_03_STR,           // bDescriptorType     1 STRING Descriptor Type
  DESC_CHAR('D'),             // bString             N UNICODE encoded string
  DESC_CHAR('G'),
  DESC_CHAR('U'),
  DESC_CHAR('T'),
  DESC_CHAR(' '),
